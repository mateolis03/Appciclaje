...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  private ActivityMapsBinding(@NonNull ConstraintLayout rootView, @NonNull Button ConsultarButton,
      @NonNull ImageView imageView, @NonNull ListView listId, @NonNull TextView textView) {
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapsBinding((ConstraintLayout) rootView, ConsultarButton, imageView,
          listId, textView);
    }
